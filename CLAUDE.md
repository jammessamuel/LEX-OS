...
| Teto de recuperação, qualidade de resposta | `docs/product/avaliacao-recuperacao.md` — a avaliação medida de 2026-09-06 que o ADR-016 exigia; `infra/scripts/avalia-recuperacao.mjs` para repetir                                                |
