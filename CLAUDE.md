...
is the only inbound channel, specialty prompts carry Thais Regina Farrapo Moreira's 2026-08-27
attestation but stay blocked over real archives until a lawyer with an active bar registration
signs, and the application never stores a password. Its fifth stop — five retrieval sources — was
reopened on 2026-09-06 by **ADR-017**, which raised the ceiling to eight after the measured
evaluation ADR-016 itself demanded; that is a superseded decision, not an authorized delivery.
External legal conditions from ADR-012 remain fail-closed and cannot be completed by engineering.
...
| Auth, RBAC, sessions                       | `docs/api/authentication.md`; `docs/decisions/decisoes.md#adr-004-use-shared-schema-application-enforced-multi-tenancy`; `apps/api/src/auth/`, `apps/api/src/access-control/`                                                          |
| People / cases / participants              | `docs/api/people-cases-participants.md`                                                                                                                                                                                                |
| Upload, storage, download                  | `docs/api/files-documents.md`; `docs/decisions/decisoes.md#adr-003-store-original-files-in-private-s3-compatible-object-storage`                                                                                                       |
...
| Teto de recuperação, qualidade de resposta | `docs/product/avaliacao-recuperacao.md` — a medida de 2026-09-06 e `infra/scripts/avalia-recuperacao.mjs` para repetir; `docs/decisions/decisoes.md#adr-017-ampliar-a-recuperação-do-assistente-para-oito-trechos` para o teto vigente |
| A instrução da especialidade é obedecida?  | `docs/product/avaliacao-por-faixa.md` — as doze faixas medidas em 2026-09-07; `infra/scripts/avalia-faixa.mjs` e `infra/avaliacao/faixas/` para repetir                                                                                |
...
| Convite, papel, bloqueio, senha            | `docs/decisions/decisoes.md#adr-014-fronteira-de-identidade-e-acesso` — **decidido 2026-08-20**: adapter de e-mail primeiro; TOTP próprio; papel nunca vem de grupo do IdP                                                             |
