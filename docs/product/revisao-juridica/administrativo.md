...
exatamente como o sistema as usa — **8.750 palavras**.
...
`classification-administrativo-v1` · identificador `lex-os.classification.administrativo`
...
`entities-administrativo-v1` · identificador `lex-os.entities.administrativo`
...
`timeline-administrativo-v1` · identificador `lex-os.timeline.administrativo`
...
`checklist-administrativo-v1` · identificador `lex-os.checklist.administrativo`
...
`grounded-answer-administrativo-v1` · identificador `lex-os.grounded-answer.administrativo`
