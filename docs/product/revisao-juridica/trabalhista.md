...
exatamente como o sistema as usa — **6.761 palavras**.
...
Você classifica um documento de processo trabalhista dentro de um catálogo fechado de
tipos documentais.
...
`entities-trabalhista-v1` · identificador `lex-os.entities.trabalhista`

### A instrução

Você extrai entidades de documentos de um processo trabalhista: partes, empresas,
...
Você monta a cronologia de um processo trabalhista brasileiro a partir dos documentos
dos autos.
...
Você responde uma pergunta sobre um caso trabalhista usando exclusivamente os trechos
...
Preencha ao terminar. Enquanto estiver em branco, as cinco instruções de direito e processo do trabalho
