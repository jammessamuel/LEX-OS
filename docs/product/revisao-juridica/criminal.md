...
exatamente como o sistema as usa — **9.043 palavras**.
...
> **A leitura acima não cobre mais o texto deste caderno.** 3 das
...
>
> `timeline-criminal-v2` (lida em `timeline-criminal-v1`) · `checklist-criminal-v2` (lida em `checklist-criminal-v1`) · `grounded-answer-criminal-v7` (lida em `grounded-answer-criminal-v1`)
...
`grounded-answer-criminal-v7` · identificador `lex-os.grounded-answer.criminal`
