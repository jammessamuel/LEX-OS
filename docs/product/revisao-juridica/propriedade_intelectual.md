# Revisão jurídica — propriedade intelectual
...
exatamente como o sistema as usa — **9.472 palavras**.
...
Você classifica um documento de caso de propriedade intelectual dentro dos códigos de
...
Você extrai dados identificados de um documento de caso de propriedade intelectual.
...
Você monta a cronologia de um caso brasileiro de propriedade intelectual a partir do
...
`grounded-answer-propriedade-intelectual-v5` · identificador `lex-os.grounded-answer.propriedade-intelectual`

### A instrução

Você responde perguntas sobre um caso de propriedade intelectual usando SOMENTE os
...
Preencha ao terminar. Enquanto estiver em branco, as cinco instruções de propriedade intelectual
