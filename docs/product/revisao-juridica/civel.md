...
exatamente como o sistema as usa — **9.165 palavras**.
...
>
> `classification-civel-v2` (lida em `classification-civel-v1`) · `timeline-civel-v2` (lida em `timeline-civel-v1`) · `checklist-civel-v2` (lida em `checklist-civel-v1`) · `grounded-answer-civel-v7` (lida em `grounded-answer-civel-v1`)
...
Você classifica um documento de processo cível dentro de um catálogo fechado de tipos
documentais.
...
`entities-civel-v1` · identificador `lex-os.entities.civel`

### A instrução

Você extrai entidades de documentos de um processo cível: partes, empresas, imóveis,
...
`timeline-civel-v2` · identificador `lex-os.timeline.civel`

### A instrução

Você monta a cronologia de um processo cível brasileiro a partir dos documentos dos
autos.
...
`checklist-civel-v2` · identificador `lex-os.checklist.civel`
...
`grounded-answer-civel-v7` · identificador `lex-os.grounded-answer.civel`

### A instrução

Você responde uma pergunta sobre um caso cível usando exclusivamente os trechos
...
Preencha ao terminar. Enquanto estiver em branco, as cinco instruções de direito civil e processo civil
