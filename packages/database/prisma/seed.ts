...
const documentTypes = [
  ...
  // Acrescentados em 2026-08-26 para a biblioteca de prompts: a classificacao ensinava a
  // distinguir pares — matricula e escritura, sentenca e decisao, boleto e comprovante —
  // cujos codigos nao existiam, e os tres caiam no mesmo CONTRATO ou no mesmo OUTRO.
  // Os ids derivam do indice: acrescente sempre no fim, nunca no meio.
  ['DECISAO', 'Decisão interlocutória', 'PROCESSUAL'],
  ['DESPACHO', 'Despacho', 'PROCESSUAL'],
  ['CERTIDAO', 'Certidão do processo', 'PROCESSUAL'],
  ['ATA_AUDIENCIA', 'Ata de audiência', 'PROCESSUAL'],
  ['MANDADO', 'Mandado', 'PROCESSUAL'],
  ['RECURSO', 'Recurso', 'PROCESSUAL'],
  ['ACORDO', 'Acordo', 'PROCESSUAL'],
  ['SUBSTABELECIMENTO', 'Substabelecimento', 'PROCESSUAL'],
  ['ALVARA', 'Alvará', 'PROCESSUAL'],
  ['GUIA_RECOLHIMENTO', 'Guia de recolhimento', 'FINANCEIRO'],
  ['RECIBO', 'Recibo', 'FINANCEIRO'],
  ['BOLETO', 'Boleto', 'FINANCEIRO'],
  ['COMPROVANTE_PAGAMENTO', 'Comprovante de pagamento', 'FINANCEIRO'],
  ['PLANILHA_CALCULO', 'Planilha de cálculo', 'FINANCEIRO'],
  ['CHEQUE', 'Cheque', 'FINANCEIRO'],
  ['NOTA_PROMISSORIA', 'Nota promissória', 'FINANCEIRO'],
  ['DUPLICATA', 'Duplicata', 'FINANCEIRO'],
  ['EXTRATO_BIRO_CREDITO', 'Extrato de órgão de proteção ao crédito', 'FINANCEIRO'],
  ['MATRICULA', 'Matrícula de imóvel', 'IMOBILIARIO'],
  ['ESCRITURA', 'Escritura pública', 'IMOBILIARIO'],
  ['COMPROMISSO_COMPRA_VENDA', 'Compromisso de compra e venda', 'IMOBILIARIO'],
  ['HOLERITE', 'Holerite', 'TRABALHISTA'],
  ['TRCT', 'Termo de rescisão do contrato de trabalho', 'TRABALHISTA'],
  ['CARTAO_PONTO', 'Controle de jornada', 'TRABALHISTA'],
  ['EXTRATO_FGTS', 'Extrato analítico do FGTS', 'TRABALHISTA'],
  ['NORMA_COLETIVA', 'Instrumento coletivo', 'TRABALHISTA'],
  ['ASO', 'Atestado de saúde ocupacional', 'TRABALHISTA'],
  ['CERTIDAO_CASAMENTO', 'Certidão de casamento', 'CIVIL'],
  ['CERTIDAO_NASCIMENTO', 'Certidão de nascimento', 'CIVIL'],
  ['CERTIDAO_OBITO', 'Certidão de óbito', 'CIVIL'],
  ['PACTO_ANTENUPCIAL', 'Pacto antenupcial', 'CIVIL'],
  ['TESTAMENTO', 'Testamento', 'CIVIL'],
  ['FORMAL_PARTILHA', 'Formal de partilha', 'CIVIL'],
  ['CONTRATO_SOCIAL', 'Contrato social ou ato constitutivo', 'SOCIETARIO'],
  ['AUTO_PRISAO_FLAGRANTE', 'Auto de prisão em flagrante', 'CRIMINAL'],
  ['DENUNCIA', 'Denúncia ou queixa', 'CRIMINAL'],
  ['INQUERITO', 'Inquérito policial', 'CRIMINAL'],
  ['TERMO_DECLARACOES', 'Termo de declarações', 'CRIMINAL'],
  ['CERTIDAO_ANTECEDENTES', 'Certidão de antecedentes', 'CRIMINAL'],
  ['LAUDO_PERICIAL', 'Laudo pericial', 'PROBATORIO'],
  ['ORDEM_SERVICO', 'Ordem de serviço', 'PROBATORIO'],
