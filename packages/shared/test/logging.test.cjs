...
describe('isUuidV4', () => {
  ...
  it('rejects anything that is not a canonical v4 identifier', () => {
    for (const value of [
      ...
      '',
      'not-a-uuid',
      '00000000-0000-1000-8000-000000000001', // versão 1
      '00000000-0000-4000-c000-000000000001', // variante inválida
      '00000000-0000-4000-8000-00000000000', // curto demais
      '00000000-0000-4000-8000-0000000000011', // longo demais
      ' 00000000-0000-4000-8000-000000000001', // espaço inicial
